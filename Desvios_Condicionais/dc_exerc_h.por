...
um dia e terminar no dia seguinte.*/
	funcao inicio()
	{
		inteiro hora_inicio, hora_fim, duracao_mesmo_dia , duracao_dia_seguinte
		...
		//duracao_mesmo_dia = hora_fim - hora_inicio
		//duracao_dia_seguinte= (24 - hora_inicio) + hora_fim

		se (hora_fim > hora_inicio) {

			duracao_mesmo_dia = hora_fim - hora_inicio
			escreva("A duração do jogo é de: ", duracao_mesmo_dia, "  hora(s).")
		}

		senao{
			duracao_dia_seguinte= (24 - hora_inicio) + hora_fim
			escreva ("A duração do jogo é de: ", duracao_dia_seguinte, "  hora(s).")
		}
		}
